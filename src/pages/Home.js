    ...
    <div className="w-full h-svh bg-accent text-white p-4 flex flex-col items-center justify-around ">
      <div className="inline-block">
        <img
          ...
          className="max-w-[120px] aspect-square"
        />
      </div>
      <div className="flex flex-col gap-6  text-center max-w-4col">
        <h1 className="font-markScript font-medium text-[32px] capitalize">
          Discover Your Signature Style
        </h1>
        <p className="text-sm font-merienda font-normal">
          where fashion meets style, and design is an art form.
        </p>
      </div>
      <div>
        <div
          className={`mb-4 capitalize text-center font-extralight ${
            visitedUser ? "block" : "hidden"
          }`}
        >
          <p>Welcome back!!</p>
          <small className="text-xs font-medium">{userName}</small>
        </div>
        <div className="inline-flex items-center gap-2.5 px-2 py-1.5 border border-secondary rounded-full">
          <button className="capitalize font-poppins font-normal">
            get started
          </button>
          <div className="bg-secondary w-[26px] h-[26px] rounded-full p-1 ">
            <IoArrowForwardOutline className="m-auto" />
          </div>
        </div>
      </div>
    </div>
...
function StatusView() {
  ...
  const test = [
    {
      imgSrc:
        "https://img.freepik.com/free-photo/fashion-stylish-model-dressed-elegant-light-pink-suit-posing-near-white-wall_158538-13394.jpg?t=st=1710607353~exp=1710610953~hmac=1c3e9972a7a3680d08fb45246ddfa674a0175baac3b66a33f4981302cc476177&w=360",
    },
    {
      imgSrc:
    ...
    {
      imgSrc:
        "https://img.freepik.com/free-photo/portrait-smiling-beautiful-girl-her-handsome-boyfriend-laughing-happy-cheerful-couple-sunglasses_158538-5002.jpg?t=st=1710608040~exp=1710611640~hmac=394a5b1d06961d1e59f570bc1051e6de8f9e53aecbd585ee48768b8b4d15ed88&w=900",
    },
    {
      imgSrc:
        "https://img.freepik.com/free-photo/pretty-young-stylish-sexy-woman-pink-luxury-dress-summer-fashion-trend-chic-style-sunglasses-blue-studio-background-shopping-holding-paper-bags-talking-mobile-phone-shopaholic_285396-2957.jpg?t=st=1710608233~exp=1710611833~hmac=411fabc325462bd7d7033c37221a0684712023102b86ba2c9e85311a4948afc0&w=1060",
  ...
  const ImageBlock = test.map((data, i) => {
    return (
      <div
        onClick={openStatus}
      ...
      >
        <div className="w-10 h-10 rounded-full ">
          <img
            src={data.imgSrc}
            className="object-contain aspect-square min-w-10 max-w-10 w-full h-10 rounded-full"
          />
        </div>
  ...
  return (
    <>
      ...
      {statusView ? (
        <div className="fixed top-0 left-0 w-full h-svh bg-black text-white z-30 overflow-hidden">
          <img
          ...
          <div className="px-[14px] absolute bottom-8 space-y-2">
            <p className="text-xl font-medium">
              We aren't just a brand; we're a statement, a celebration of your
              unique style.
            </p>
            <p className="text-sm font-light">
              we believe that fashion is a reflection of your personality. Our
              carefully crafted designs are not just clothes.
            </p>
          </div>
  ...
  return (
    <>
      <div
        ...
        className={`pointer-events-auto h-6 w-10 rounded-full p-1 ring-1 ring-inset transition duration-200 ease-in-out  ring-secondaryAccent/5 ${
          toggle ? "bg-accent" : "bg-zinc-200"
        }`}
      >
        <div
      ...
      {toggle ? (
        ...
        <div className="fixed top-0 left-0 w-full h-svh bg-black/25 z-[500] flex justify-center items-center p-4">
          <div className="max-w-sm mx-auto w-auto bg-white p-6  rounded-sm text-sm text-center text-secondary">
            please make sure, your location is <br /> enable.
            <div className="mt-4">
              <button
                className="mt-2 px-6 py-2 bg-secondary text-white rounded-full"
                onClick={handelToggle}
              >
                Allow
              </button>
...
function Recommended() {
  ...
  if (loading) {
    items = (
      <div className="flex gap-2 items-center justify-between overflow-x-scroll py-2.5 px-2 w-full">
        <div className="bg-slate-200 w-10 h-10 animate-pulse rounded-full"></div>
        <div className="bg-slate-200 w-10 h-10 animate-pulse rounded-full"></div>
        <div className="bg-slate-200 w-10 h-10 animate-pulse rounded-full"></div>
        <div className="bg-slate-200 w-10 h-10 animate-pulse rounded-full"></div>
      </div>
        ...
        <NavLink key={i} to="/categories">
          <div className="flex flex-col gap-1 items-center ">
            <div className="w-10 h-10 rounded-full bg-slate-200 flex-shrink-0">
              <img
                src={require(`../asset/images/recommendimgs/recomimg${
                  i + 1
                }.jpg`)}
                className="w-full h-full object-cover rounded-full"
              />
            </div>
            <small className="text-xs capitalize w-full max-w-28 whitespace-nowrap overflow-hidden text-ellipsis text-center">
              {listItem}
            </small>
          </div>
        </NavLink>
...
function TrendingProduct() {
  ...
  if (loading) {
    productCard = (
      <>
        <div className="w-full h-44 animate-pulse bg-bg-tab rounded-xl"></div>
        <div className="w-full h-44 animate-pulse bg-bg-tab rounded-xl"></div>
        <div className="w-full h-44 animate-pulse bg-bg-tab rounded-xl"></div>
        <div className="w-full h-44 animate-pulse bg-bg-tab rounded-xl"></div>
      </>
    ...
    productCard = data.map((item) => {
      return <Card details={item} key={item.id} productID={item.id} />;
    });
  }
  return <>{productCard}</>;
}
...
function BannerSlider() {
  ...
  return (
    <Slider {...settings}>
      <div>
        <img
          src={require("../asset/images/4eb2ab40d43c00f4663d8712fd446594.jpg")}
          className="object-contain md:object-cover w-full h-full"
        />
      </div>
      <div>
        <img
          src={require("../asset/images/banner/banner2.png")}
          className="object-contain md:object-cover w-full h-full"
        />
      </div>
      <div>
        <img
          src={require("../asset/images/banner/banner3.png")}
          className="object-contain md:object-cover w-full h-full"
        />
      </div>
      <div>
        <img
          src={require("../asset/images/banner/banner4.png")}
          className="object-contain md:object-cover w-full h-full"
        />
      </div>
      <div>
        <img
          src={require("../asset/images/banner/banner1.png")}
          className="object-contain md:object-cover w-full h-full"
        />
      </div>
      <div>
        <img
          src={require("../asset/images/banner/banner5.png")}
          className="object-contain md:object-cover w-full h-full"
        />
      </div>
    </Slider>
...
function BannerSlide2() {
  ...
  return (
    <>
      <h1 className="uppercase text-secondary text-[2.50rem] text-center px-4">
        carry your dream’s even higher
      </h1>
      <div className="mt-10 px-4">
        <button
          className="capitalize font-light text-white bg-black text-xl rounded-full px-4 py-3 w-full"
      ...
      <div className="mt-10 banner2">
        <Slider {...settings}>
          <div className="">
            <img
              src={require("../asset/images/banner/bslide1.png")}
              className="object-contain "
            />
          </div>
          <div className="">
            <img
              src={require("../asset/images/banner/bslide2.png")}
              className="object-contain "
            />
          </div>
          <div className="">
            <img
              src={require("../asset/images/banner/bslide3.png")}
              className="object-contain "
            />
          </div>
        </Slider>
  ...
  return (
    <>
      <div className="relative">
        <img
          src={require("../asset/images/banner/small banners.png")}
          className="object-contain rounded-sm max-h-[150px] max-w-[100px] w-full h-full"
        />
        <p className="absolute bottom-3.5 capitalize left-1/2 -translate-x-1/2 whitespace-nowrap font-medium text-white text-center">
          top trends
        </p>
      </div>
    </>
...
function CenterContent() {
  ...
  brandImg = imgSrc.map((data) => {
    if (data.length == 5350 || data.length == 3978) {
      return (
        <div
          className="max-w-20 w-full h-full rounded-md col-span-3"
          key={data.length}
        >
          <img src={data} alt="brandImage" />
        </div>
      );
    } else {
      return (
        <div
          className="max-w-20 w-full h-full rounded-md col-span-2"
          key={data.length}
        >
          <img src={data} alt="brandImage" />
        </div>
    ...
    <section>
        ...
        <div className="flex items-center gap-1.5">
          <div className="flex justify-center items-center">
            <button
              ...
              className="w-10 h-10 rounded-full  flex justify-center items-center relative active:bg-halfWhite/75"
            >
              <HiShoppingCart className="text-xl m-auto" />
              <div className="p-1 w-3.5 h-3.5 rounded-full bg-secondary text-white text-[8px] font-medium flex justify-center items-center absolute -top-1 left-1/2 -translate-x-1/2">
                {state.count}
              </div>
            </button>
          </div>
      ...
      <div className="mt-6 px-4 flex justify-between items-center">
        <div className="inline-flex items-center gap-1.5">
          ...
          <p className="text-secondary font-normal capitalize">
            Chennai
            <small className="text-[9px] text-tertiary font-light block leading-[.5] ps-1">
              Location
            </small>
          </p>
        </div>
      ...
      <div className="mt-6 px-4">
        <input
          ...
          className="border border-secondary rounded-full px-5 py-2 w-full  placeholder:text-sm placeholder:font-extralight focus-within:outline-none min-h-11"
        />
      </div>
      {/* banners  */}
      <div className="mt-11">
      ...
      <div className="mt-6 px-4 flex justify-between items-center capitalize">
        ...
        <NavLink to="/categories">
          <button className=" text-[10px] font-medium text-accent mr-6 ">
            view all
          </button>
        </NavLink>
      </div>
      ...
      <div className="h-screen mt-6  relative">
        <img
          src={require("../asset/images/productsimage/h&m.png")}
      ...
      {/* recommended */}
      <div className="mt-6">
        <h1 className="capitalize font-medium text-sm text-secondary mb-2 px-4">
          recommended for you
        </h1>
        <Recommended />
      </div>
      ...
      <div className="mt-6 px-4">
        <div className="border bg-gradient-to-r from-violet-200 via-accent/75 to-pink-200 border-secondary w-full max-w-[304px] mx-auto pt-1.5 rounded-sm ">
          <div className="bg-white p-2.5 py-4 rounded-sm rounded-tr-none rounded-tl-none flex flex-col gap-4">
            <h1 className="capitalize font-medium text-lg text-black text-center ">
              membership
            </h1>
            <p className=" text-xs font-light text-center px-5">
              Enjoy exclusive benefits and discounts when you join.
            </p>
            <div className="flex justify-center">
              <NavLink to="/membership">
                <button className="font-normal px-7 py-2 bg-secondary text-white rounded-full text-base text-center mx-auto active:bg-secondary/75">
                  Add
                </button>
              </NavLink>
            </div>
      ...
      <section className="mt-6 px-4">
        <div className="py-2 flex gap-2 overflow-x-auto">
          <div className="min-w-40 h-72 rounded-sm relative">
            <img
              src="https://cdn.pixabay.com/photo/2017/07/20/10/02/portrait-2521800_1280.jpg"
          ...
          <div className="min-w-40 h-72 rounded-sm relative">
            <img
              src="https://cdn.pixabay.com/photo/2018/10/10/14/24/shirt-3737405_1280.jpg"
              className="w-full h-full rounded-sm object-cover object-center"
            />
            <div className="absolute bottom-2 left-2 rounded-xs bg-white px-3 py-1.5 text-secondary text-xs font-normal font-merienda">
              men's
          ...
          <div className="min-w-40 h-72 rounded-sm relative">
            <img
              src="https://cdn.pixabay.com/photo/2019/11/21/15/00/woman-4642701_1280.jpg"
              className="w-full h-full rounded-sm object-cover object-center"
            />
          ...
          <div className="min-w-40 h-72 rounded-sm relative">
            <img
              src="https://cdn.pixabay.com/photo/2019/09/09/14/55/fashion-4463802_1280.jpg"
              className="w-full h-full rounded-sm object-cover object-center"
            />
            <div className="absolute bottom-2 left-2 rounded-xs bg-white px-3 py-1.5 text-secondary text-sm font-normal font-merienda">
              trends's
...
function Home() {
  ...
  useEffect(() => {
    ...
    if (!hasShownGreeting) {
      ...
      setState({ ...state, greeting: true });
      localStorage.setItem("hasShownGreeting", true);
      setState({ ...state, loader: !state.loader });
      // setLoader(!loader)
      setTimeout(() => {
        // setShowGreeting(false);
        setState({ ...state, greeting: false, loader: !state.loader });
      }, 3000);
    } else {
      setState({ ...state, greeting: false, loader: false });
      // setShowGreeting(false);
      // setLoader(!loader)
    }
  }, []);
    ...
    <>
      {state.loader ? (
        <div className="flex items-center justify-center min-h-screen">
          <span className="border-4 border-r-gray-200/25 border-gray-400 w-10 h-10 rounded-full animate-spin"></span>
        </div>
      ) : state.greeting ? (
        <WelcomeScreen />
      ) : (
